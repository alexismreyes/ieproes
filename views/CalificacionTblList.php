...
<?php } ?>
        ...
        .addFields([
            ...
            ["observacion_calificacion", [], fields.observacion_calificacion.isInvalid],
...
?>
    <div id="xs_fk_id_alumno" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->fk_id_alumno->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fcalificacion_tblsrch_x_fk_id_alumno"
        ...
        <script>
        loadjs.ready("fcalificacion_tblsrch", function() {
            var options = {
                name: "x_fk_id_alumno",
                selectId: "fcalificacion_tblsrch_x_fk_id_alumno",
                ajax: { id: "x_fk_id_alumno", form: "fcalificacion_tblsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.calificacion_tbl.fields.fk_id_alumno.filterOptions);
...
?>
    <div id="xs_fk_id_evaluacion" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->fk_id_evaluacion->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fcalificacion_tblsrch_x_fk_id_evaluacion"
            data-table="calificacion_tbl"
        ...
        loadjs.ready("fcalificacion_tblsrch", function() {
            var options = {
                name: "x_fk_id_evaluacion",
                selectId: "fcalificacion_tblsrch_x_fk_id_evaluacion",
                ajax: { id: "x_fk_id_evaluacion", form: "fcalificacion_tblsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.calificacion_tbl.fields.fk_id_evaluacion.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
