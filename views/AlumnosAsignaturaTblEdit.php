...
<span id="el_alumnos_asignatura_tbl_fk_id_alumno">
    <select
        ...
        data-select2-id="falumnos_asignatura_tbledit_x_fk_id_alumno"
...
loadjs.ready("falumnos_asignatura_tbledit", function() {
    var options = { name: "x_fk_id_alumno", selectId: "falumnos_asignatura_tbledit_x_fk_id_alumno" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (falumnos_asignatura_tbledit.lists.fk_id_alumno?.lookupOptions.length) {
        options.data = { id: "x_fk_id_alumno", form: "falumnos_asignatura_tbledit" };
    } else {
        options.ajax = { id: "x_fk_id_alumno", form: "falumnos_asignatura_tbledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
