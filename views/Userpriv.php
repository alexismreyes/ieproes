...
window.Tabulator || loadjs([
    ew.PATH_BASE + "css/<?= CssFile("tabulator_bootstrap5.css", false) ?>?v=19.5.3",
    ew.PATH_BASE + "js/tabulator.min.js?v=19.5.3"
], "tabulator");
</script>
<style>
main .tooltip {
...
<script>
ew.ready(["load", "tabulator"], ew.PATH_BASE + "js/userpriv.min.js?v=19.5.3");
</script>
