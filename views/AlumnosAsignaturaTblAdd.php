...
<script>
loadjs.ready("falumnos_asignatura_tbladd", function() {
    falumnos_asignatura_tbladd.createAutoSuggest(Object.assign({"id":"x_fk_id_alumno","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->fk_id_alumno->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.alumnos_asignatura_tbl.fields.fk_id_alumno.autoSuggestOptions));
});
</script>
