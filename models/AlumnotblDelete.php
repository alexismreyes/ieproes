 ...
 * Page class
 */
class AlumnotblDelete extends Alumnotbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlumnotblDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AlumnotblDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AlumnotblList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AlumnotblList"); // Return to list
                return;
            }
        }
