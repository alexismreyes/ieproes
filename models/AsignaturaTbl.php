...
/**
 * Table class for asignatura_tbl
 */
class AsignaturaTbl extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`asignatura_tbl`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id_asignatura->IsForeignKey = true; // Foreign key field
        $this->id_asignatura->Sortable = false; // Allow sort
        ...
        $this->id_profesor->addMethod("getSelectFilter", fn() => "`tipo_usuario`=1");
        $this->id_profesor->InputTextType = "text";
        $this->id_profesor->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->id_profesor->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->id_profesor->Lookup = new Lookup('id_profesor', 'usuarios_tbl', false, 'id_usuario', ["nombre_usuario","","",""], '', '', [], [], [], [], [], [], '', '', "`nombre_usuario`");
                break;
            default:
                $this->id_profesor->Lookup = new Lookup('id_profesor', 'usuarios_tbl', false, 'id_usuario', ["nombre_usuario","","",""], '', '', [], [], [], [], [], [], '', '', "`nombre_usuario`");
                break;
        ...
        $this->id_profesor->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "calificacion_tbl") {
            ...
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id_asignatura", $this->id_asignatura->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "AsignaturaTblList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`asignatura_tbl`";
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_asignatura']) && $rsold['id_asignatura'] != $rs['id_asignatura'])) { // Update detail field 'fk_id_asignatura'
            $cascadeUpdate = true;
            $rscascade['fk_id_asignatura'] = $rs['id_asignatura'];
        }
        if ($cascadeUpdate) {
            $rswrk = Container("calificacion_tbl")->loadRs("`fk_id_asignatura` = " . QuotedValue($rsold['id_asignatura'], DATATYPE_NUMBER, 'DB'))->fetchAllAssociative();
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("calificacion_tbl")->loadRs("`fk_id_asignatura` = " . QuotedValue($rs['id_asignatura'], DATATYPE_NUMBER, "DB"))->fetchAllAssociative();
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AsignaturaTblList");
    }
    ...
    {
        global $Language;
        if ($pageName == "AsignaturaTblView") {
            return $Language->phrase("View");
        } elseif ($pageName == "AsignaturaTblEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AsignaturaTblAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AsignaturaTblView";
            case Config("API_ADD_ACTION"):
                return "AsignaturaTblAdd";
            case Config("API_EDIT_ACTION"):
                return "AsignaturaTblEdit";
            case Config("API_DELETE_ACTION"):
                return "AsignaturaTblDelete";
            case Config("API_LIST_ACTION"):
                return "AsignaturaTblList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AsignaturaTblView", $parm);
        } else {
            $url = $this->keyUrl("AsignaturaTblView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "AsignaturaTblAdd?" . $parm;
        } else {
            $url = "AsignaturaTblAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AsignaturaTblEdit", $parm);
        } else {
            $url = $this->keyUrl("AsignaturaTblEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AsignaturaTblList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AsignaturaTblAdd", $parm);
        } else {
            $url = $this->keyUrl("AsignaturaTblAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AsignaturaTblList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AsignaturaTblDelete");
        }
    }
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `asignatura_tbl`";
