...
/**
 * Table class for alumnosporasigntura_vw
 */
class AlumnosporasignturaVw extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`alumnosporasigntura_vw`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->fk_id_asignatura->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`alumnosporasigntura_vw`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AlumnosporasignturaVwList");
    }
    ...
    {
        global $Language;
        if ($pageName == "AlumnosporasignturaVwView") {
            return $Language->phrase("View");
        } elseif ($pageName == "AlumnosporasignturaVwEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AlumnosporasignturaVwAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AlumnosporasignturaVwView";
            case Config("API_ADD_ACTION"):
                return "AlumnosporasignturaVwAdd";
            case Config("API_EDIT_ACTION"):
                return "AlumnosporasignturaVwEdit";
            case Config("API_DELETE_ACTION"):
                return "AlumnosporasignturaVwDelete";
            case Config("API_LIST_ACTION"):
                return "AlumnosporasignturaVwList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AlumnosporasignturaVwView", $parm);
        } else {
            $url = $this->keyUrl("AlumnosporasignturaVwView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "AlumnosporasignturaVwAdd?" . $parm;
        } else {
            $url = "AlumnosporasignturaVwAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AlumnosporasignturaVwEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AlumnosporasignturaVwList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AlumnosporasignturaVwAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AlumnosporasignturaVwList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AlumnosporasignturaVwDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "AlumnosporasignturaVwList";
    ...
    public function renderEditRow()
    {
        ...
        $this->fk_id_asignatura->EditValue = $this->fk_id_asignatura->CurrentValue;
        $this->fk_id_asignatura->PlaceHolder = RemoveHtml($this->fk_id_asignatura->caption());
        if (strval($this->fk_id_asignatura->EditValue) != "" && is_numeric($this->fk_id_asignatura->EditValue)) {
            $this->fk_id_asignatura->EditValue = FormatNumber($this->fk_id_asignatura->EditValue, null);
        }
