 ...
 * Page class
 */
class UsuariosTblEdit extends UsuariosTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsuariosTblEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "UsuariosTblEdit";
    ...
    protected function editRow()
    {
        ...
        // login_usuario
        $this->login_usuario->setDbValueDef($rsnew, $this->login_usuario->CurrentValue, "", $this->login_usuario->ReadOnly);

        // password_usuario
        if (!IsMaskedPassword($this->password_usuario->CurrentValue)) {
            $this->password_usuario->setDbValueDef($rsnew, $this->password_usuario->CurrentValue, "", $this->password_usuario->ReadOnly || Config("ENCRYPTED_PASSWORD") && $rsold['password_usuario'] == $this->password_usuario->CurrentValue);
        }

        // email_usuario
        $this->email_usuario->setDbValueDef($rsnew, $this->email_usuario->CurrentValue, null, $this->email_usuario->ReadOnly);

        // parent_id_usuario
        $this->parent_id_usuario->setDbValueDef($rsnew, $this->parent_id_usuario->CurrentValue, 0, $this->parent_id_usuario->ReadOnly);
