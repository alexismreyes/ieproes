 ...
 * Page class
 */
class AlumnosAsignaturaTblDelete extends AlumnosAsignaturaTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlumnosAsignaturaTblDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AlumnosAsignaturaTblDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AlumnosAsignaturaTblList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AlumnosAsignaturaTblList"); // Return to list
                return;
            }
        }
