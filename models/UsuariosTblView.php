 ...
 * Page class
 */
class UsuariosTblView extends UsuariosTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsuariosTblView";
    ...
    // CSS class/style
    public $CurrentPageName = "UsuariosTblView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id_usuario") ?? Route("id_usuario")) !== null) {
            ...
            $returnUrl = "UsuariosTblList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UsuariosTblList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
