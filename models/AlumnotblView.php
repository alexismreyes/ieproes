 ...
 * Page class
 */
class AlumnotblView extends Alumnotbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlumnotblView";
    ...
    // CSS class/style
    public $CurrentPageName = "AlumnotblView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_alumno") ?? Route("id_alumno")) !== null) {
            $this->RecKey["id_alumno"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id_alumno") ?? Route("id_alumno")) !== null) {
            ...
            $this->RecKey["id_alumno"] = $this->id_alumno->QueryStringValue;
        } elseif (Post("id_alumno") !== null) {
            $this->id_alumno->setFormValue(Post("id_alumno"));
            $this->RecKey["id_alumno"] = $this->id_alumno->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_alumno->setQueryStringValue($keyValue);
            $this->RecKey["id_alumno"] = $this->id_alumno->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AlumnotblList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AlumnotblList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
