 ...
 * Page class
 */
class CalificacionTblDelete extends CalificacionTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionTblDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CalificacionTblDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CalificacionTblList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CalificacionTblList"); // Return to list
                return;
            }
        }
