 ...
 * Page class
 */
class ProfesorTblView extends ProfesorTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProfesorTblView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProfesorTblView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_profesor") ?? Route("id_profesor")) !== null) {
            $this->RecKey["id_profesor"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id_profesor") ?? Route("id_profesor")) !== null) {
            ...
            $this->RecKey["id_profesor"] = $this->id_profesor->QueryStringValue;
        } elseif (Post("id_profesor") !== null) {
            $this->id_profesor->setFormValue(Post("id_profesor"));
            $this->RecKey["id_profesor"] = $this->id_profesor->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_profesor->setQueryStringValue($keyValue);
            $this->RecKey["id_profesor"] = $this->id_profesor->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ProfesorTblList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProfesorTblList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
