...
/**
 * Table class for ReporteCalificaciones
 */
class ReporteCalificaciones extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "ReporteCalificaciones";
        $this->TableName = 'ReporteCalificaciones';
        $this->TableType = "REPORT";
        $this->ReportSourceTable = 'calificacion_tbl'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_calificacion
        $this->id_calificacion = new ReportField(
            $this, // Table
        ...
        $this->id_calificacion->SourceTableVar = 'calificacion_tbl';
        $this->Fields['id_calificacion'] = &$this->id_calificacion;

        // fk_id_asignatura
        $this->fk_id_asignatura = new ReportField(
            $this, // Table
        ...
        $this->fk_id_asignatura->SourceTableVar = 'calificacion_tbl';
        $this->Fields['fk_id_asignatura'] = &$this->fk_id_asignatura;

        // fk_id_alumno
        $this->fk_id_alumno = new ReportField(
            $this, // Table
        ...
        $this->fk_id_alumno->SourceTableVar = 'calificacion_tbl';
        $this->Fields['fk_id_alumno'] = &$this->fk_id_alumno;

        // nota_calificacion
        $this->nota_calificacion = new ReportField(
            $this, // Table
        ...
        $this->nota_calificacion->SourceTableVar = 'calificacion_tbl';
        $this->Fields['nota_calificacion'] = &$this->nota_calificacion;

        // observacion_calificacion
        $this->observacion_calificacion = new ReportField(
            $this, // Table
        ...
        $this->observacion_calificacion->SourceTableVar = 'calificacion_tbl';
        $this->Fields['observacion_calificacion'] = &$this->observacion_calificacion;

        // fk_id_evaluacion
        $this->fk_id_evaluacion = new ReportField(
            $this, // Table
        ...
        $this->fk_id_evaluacion->SourceTableVar = 'calificacion_tbl';
    ...
    {
        return "ReporteCalificacionesSummary";
    }
