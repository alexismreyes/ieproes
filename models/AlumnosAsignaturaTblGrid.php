 ...
 * Page class
 */
class AlumnosAsignaturaTblGrid extends AlumnosAsignaturaTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlumnosAsignaturaTblGrid";
    ...
    public $FormName = "falumnos_asignatura_tblgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "AlumnosAsignaturaTblGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_alumnosasignatura->CurrentValue;
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['id_alumnosasignatura'];
