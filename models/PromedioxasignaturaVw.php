...
/**
 * Table class for promedioxasignatura_vw
 */
class PromedioxasignaturaVw extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`promedioxasignatura_vw`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->CONCATalmnombre_alumnoalmapellidos_alumno = new DbField(
            $this, // Table
        ...
        $this->AVGcalnota_calificacion = new DbField(
            $this, // Table
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->CONCATalmnombre_alumnoalmapellidos_alumno->DbValue = $row['CONCAT(alm.`nombre_alumno`,\' \',alm.`apellidos_alumno`)'];
        $this->nombre_asignatura->DbValue = $row['nombre_asignatura'];
        $this->AVGcalnota_calificacion->DbValue = $row['AVG(cal.`nota_calificacion`)'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PromedioxasignaturaVwList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PromedioxasignaturaVwView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PromedioxasignaturaVwEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PromedioxasignaturaVwAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PromedioxasignaturaVwView";
            case Config("API_ADD_ACTION"):
                return "PromedioxasignaturaVwAdd";
            case Config("API_EDIT_ACTION"):
                return "PromedioxasignaturaVwEdit";
            case Config("API_DELETE_ACTION"):
                return "PromedioxasignaturaVwDelete";
            case Config("API_LIST_ACTION"):
                return "PromedioxasignaturaVwList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PromedioxasignaturaVwView", $parm);
        } else {
            $url = $this->keyUrl("PromedioxasignaturaVwView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PromedioxasignaturaVwAdd?" . $parm;
        } else {
            $url = "PromedioxasignaturaVwAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PromedioxasignaturaVwEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PromedioxasignaturaVwList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PromedioxasignaturaVwAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PromedioxasignaturaVwList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PromedioxasignaturaVwDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "PromedioxasignaturaVwList";
    ...
    public function renderEditRow()
    {
        ...
        // CONCAT(alm.`nombre_alumno`,' ',alm.`apellidos_alumno`)
        $this->CONCATalmnombre_alumnoalmapellidos_alumno->setupEditAttributes();
        if (!$this->CONCATalmnombre_alumnoalmapellidos_alumno->Raw) {
            $this->CONCATalmnombre_alumnoalmapellidos_alumno->CurrentValue = HtmlDecode($this->CONCATalmnombre_alumnoalmapellidos_alumno->CurrentValue);
        }
        $this->CONCATalmnombre_alumnoalmapellidos_alumno->EditValue = $this->CONCATalmnombre_alumnoalmapellidos_alumno->CurrentValue;
        $this->CONCATalmnombre_alumnoalmapellidos_alumno->PlaceHolder = RemoveHtml($this->CONCATalmnombre_alumnoalmapellidos_alumno->caption());
        ...
        // AVG(cal.`nota_calificacion`)
        $this->AVGcalnota_calificacion->setupEditAttributes();
        $this->AVGcalnota_calificacion->EditValue = $this->AVGcalnota_calificacion->CurrentValue;
        $this->AVGcalnota_calificacion->PlaceHolder = RemoveHtml($this->AVGcalnota_calificacion->caption());
        if (strval($this->AVGcalnota_calificacion->EditValue) != "" && is_numeric($this->AVGcalnota_calificacion->EditValue)) {
            $this->AVGcalnota_calificacion->EditValue = FormatNumber($this->AVGcalnota_calificacion->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->CONCATalmnombre_alumnoalmapellidos_alumno);
                    $doc->exportCaption($this->nombre_asignatura);
                    $doc->exportCaption($this->AVGcalnota_calificacion);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->CONCATalmnombre_alumnoalmapellidos_alumno);
                        $doc->exportField($this->nombre_asignatura);
                        $doc->exportField($this->AVGcalnota_calificacion);
