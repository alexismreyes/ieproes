 ...
 * Page class
 */
class CalificacionTblView extends CalificacionTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionTblView";
    ...
    // CSS class/style
    public $CurrentPageName = "CalificacionTblView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id_calificacion") ?? Route("id_calificacion")) !== null) {
            ...
            $returnUrl = "CalificacionTblList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CalificacionTblList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
