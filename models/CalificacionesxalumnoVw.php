...
/**
 * Table class for calificacionesxalumno_vw
 */
class CalificacionesxalumnoVw extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`calificacionesxalumno_vw`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id_profesor->Sortable = false; // Allow sort
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`calificacionesxalumno_vw`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CalificacionesxalumnoVwList");
    }
    ...
    {
        global $Language;
        if ($pageName == "CalificacionesxalumnoVwView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CalificacionesxalumnoVwEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CalificacionesxalumnoVwAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CalificacionesxalumnoVwView";
            case Config("API_ADD_ACTION"):
                return "CalificacionesxalumnoVwAdd";
            case Config("API_EDIT_ACTION"):
                return "CalificacionesxalumnoVwEdit";
            case Config("API_DELETE_ACTION"):
                return "CalificacionesxalumnoVwDelete";
            case Config("API_LIST_ACTION"):
                return "CalificacionesxalumnoVwList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CalificacionesxalumnoVwView", $parm);
        } else {
            $url = $this->keyUrl("CalificacionesxalumnoVwView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "CalificacionesxalumnoVwAdd?" . $parm;
        } else {
            $url = "CalificacionesxalumnoVwAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CalificacionesxalumnoVwEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CalificacionesxalumnoVwList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CalificacionesxalumnoVwAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CalificacionesxalumnoVwList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("CalificacionesxalumnoVwDelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "CalificacionesxalumnoVwList";
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `calificacionesxalumno_vw`";
