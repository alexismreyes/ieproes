 ...
 * Page class
 */
class ProfesorTblAdd extends ProfesorTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProfesorTblAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProfesorTblAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ProfesorTblView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // nombre_profesor
        $this->nombre_profesor->setDbValueDef($rsnew, $this->nombre_profesor->CurrentValue, "", false);

        // dui_profesor
        $this->dui_profesor->setDbValueDef($rsnew, $this->dui_profesor->CurrentValue, "", false);

        // direccion_profesor
        $this->direccion_profesor->setDbValueDef($rsnew, $this->direccion_profesor->CurrentValue, null, false);

        // telefono_profesor
        $this->telefono_profesor->setDbValueDef($rsnew, $this->telefono_profesor->CurrentValue, null, false);

        // email_profesor
        $this->email_profesor->setDbValueDef($rsnew, $this->email_profesor->CurrentValue, null, false);
