 ...
 * Page class
 */
class Login extends UsuariosTbl
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("usuarios_tbl", "username", "username", "username", "", 202, 255, -1, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-form-control");
        $this->Password = new DbField("usuarios_tbl", "password", "password", "password", "", 202, 255, -1, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-form-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("usuarios_tbl", "type", "logintype", "logintype", "", 202, 255, -1, false, "", false, false, false);
