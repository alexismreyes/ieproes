 ...
 * Page class
 */
class AlumnosAsignaturaTblView extends AlumnosAsignaturaTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlumnosAsignaturaTblView";
    ...
    // CSS class/style
    public $CurrentPageName = "AlumnosAsignaturaTblView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_alumnosasignatura") ?? Route("id_alumnosasignatura")) !== null) {
            $this->RecKey["id_alumnosasignatura"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->id_alumnosasignatura->setVisibility();
        ...
        if (($keyValue = Get("id_alumnosasignatura") ?? Route("id_alumnosasignatura")) !== null) {
            ...
            $this->RecKey["id_alumnosasignatura"] = $this->id_alumnosasignatura->QueryStringValue;
        } elseif (Post("id_alumnosasignatura") !== null) {
            $this->id_alumnosasignatura->setFormValue(Post("id_alumnosasignatura"));
            $this->RecKey["id_alumnosasignatura"] = $this->id_alumnosasignatura->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_alumnosasignatura->setQueryStringValue($keyValue);
            $this->RecKey["id_alumnosasignatura"] = $this->id_alumnosasignatura->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AlumnosAsignaturaTblList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AlumnosAsignaturaTblList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
