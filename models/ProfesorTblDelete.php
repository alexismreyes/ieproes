 ...
 * Page class
 */
class ProfesorTblDelete extends ProfesorTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProfesorTblDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProfesorTblDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProfesorTblList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ProfesorTblList"); // Return to list
                return;
            }
        }
