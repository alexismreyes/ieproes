 ...
 * Page class
 */
class UsuariosTblDelete extends UsuariosTbl
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsuariosTblDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "UsuariosTblDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UsuariosTblList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("UsuariosTblList"); // Return to list
            return;
        }
