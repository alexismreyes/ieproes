 ...
 * Page class
 */
class ReporteCalificacionesSummary extends ReporteCalificaciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReporteCalificacionesSummary";
    ...
    public $CurrentPageName = "ReporteCalificaciones";
    ...
    public function __construct()
    {
        ...
        // Table object (ReporteCalificaciones)
        if (!isset($GLOBALS["ReporteCalificaciones"]) || get_class($GLOBALS["ReporteCalificaciones"]) == PROJECT_NAMESPACE . "ReporteCalificaciones") {
            $GLOBALS["ReporteCalificaciones"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'ReporteCalificaciones');
        }
    ...
    {
        $data = [];
        $data["id_calificacion"] = $record['id_calificacion'];
        $data["fk_id_asignatura"] = $record['fk_id_asignatura'];
        $data["fk_id_alumno"] = $record['fk_id_alumno'];
        $data["nota_calificacion"] = $record['nota_calificacion'];
        $data["observacion_calificacion"] = $record['observacion_calificacion'];
        $data["fk_id_evaluacion"] = $record['fk_id_evaluacion'];
        $this->Rows[] = $data;
        $this->id_calificacion->setDbValue($record['id_calificacion']);
        $this->fk_id_asignatura->setDbValue($record['fk_id_asignatura']);
        $this->fk_id_alumno->setDbValue($record['fk_id_alumno']);
        $this->nota_calificacion->setDbValue($record['nota_calificacion']);
        $this->observacion_calificacion->setDbValue($record['observacion_calificacion']);
        $this->fk_id_evaluacion->setDbValue($record['fk_id_evaluacion']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) {
            ...
            $this->fk_id_asignatura->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->fk_id_alumno->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->fk_id_evaluacion->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
            ...
            // fk_id_asignatura
            $currentValue = $this->fk_id_asignatura->CurrentValue;
            $viewValue = &$this->fk_id_asignatura->ViewValue;
            $viewAttrs = &$this->fk_id_asignatura->ViewAttrs;
            $cellAttrs = &$this->fk_id_asignatura->CellAttrs;
            $hrefValue = &$this->fk_id_asignatura->HrefValue;
            $linkAttrs = &$this->fk_id_asignatura->LinkAttrs;
            $this->cellRendered($this->fk_id_asignatura, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // fk_id_alumno
            $currentValue = $this->fk_id_alumno->CurrentValue;
            $viewValue = &$this->fk_id_alumno->ViewValue;
            $viewAttrs = &$this->fk_id_alumno->ViewAttrs;
            $cellAttrs = &$this->fk_id_alumno->CellAttrs;
            $hrefValue = &$this->fk_id_alumno->HrefValue;
            $linkAttrs = &$this->fk_id_alumno->LinkAttrs;
            $this->cellRendered($this->fk_id_alumno, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
            ...
            // fk_id_evaluacion
            $currentValue = $this->fk_id_evaluacion->CurrentValue;
            $viewValue = &$this->fk_id_evaluacion->ViewValue;
            $viewAttrs = &$this->fk_id_evaluacion->ViewAttrs;
            $cellAttrs = &$this->fk_id_evaluacion->CellAttrs;
            $hrefValue = &$this->fk_id_evaluacion->HrefValue;
            $linkAttrs = &$this->fk_id_evaluacion->LinkAttrs;
            $this->cellRendered($this->fk_id_evaluacion, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->fk_id_asignatura->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->fk_id_alumno->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->nota_calificacion->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->fk_id_evaluacion->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fReporteCalificacionessrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fReporteCalificacionessrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    protected function getExtendedFilter()
    {
        ...
        if (Get("cmd") == "reset") {
            ...
            // Field fk_id_alumno
            $this->getDropDownValue($this->fk_id_alumno);

            // Field fk_id_evaluacion
            $this->getDropDownValue($this->fk_id_evaluacion);
        ...
        if ($restoreSession) {
            $restoreDefault = true;
            if ($this->fk_id_alumno->AdvancedSearch->issetSession()) { // Field fk_id_alumno
                $this->fk_id_alumno->AdvancedSearch->load();
                $restoreDefault = false;
            }
            if ($this->fk_id_evaluacion->AdvancedSearch->issetSession()) { // Field fk_id_evaluacion
        ...
        $this->buildDropDownFilter($this->fk_id_alumno, $filter, false, true); // Field fk_id_alumno
        $this->fk_id_alumno->AdvancedSearch->save();
        $this->buildDropDownFilter($this->fk_id_evaluacion, $filter, false, true); // Field fk_id_evaluacion
