 ...
 * Page class
 */
class PromedioxasignaturaRptSummary extends PromedioxasignaturaRpt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PromedioxasignaturaRptSummary";
    ...
    public $CurrentPageName = "PromedioxasignaturaRpt";
    ...
    public function __construct()
    {
        ...
        // Table object (promedioxasignatura_rpt)
        if (!isset($GLOBALS["promedioxasignatura_rpt"]) || get_class($GLOBALS["promedioxasignatura_rpt"]) == PROJECT_NAMESPACE . "promedioxasignatura_rpt") {
            $GLOBALS["promedioxasignatura_rpt"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'promedioxasignatura_rpt');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["AVGcalnota_calificacion"] = $record['AVG(cal.`nota_calificacion`)'];
        ...
        $this->AVGcalnota_calificacion->setDbValue($record['AVG(cal.`nota_calificacion`)']);
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->AVGcalnota_calificacion->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
            ...
            // AVG(cal.`nota_calificacion`)
            $currentValue = $this->AVGcalnota_calificacion->CurrentValue;
            $viewValue = &$this->AVGcalnota_calificacion->ViewValue;
            $viewAttrs = &$this->AVGcalnota_calificacion->ViewAttrs;
            $cellAttrs = &$this->AVGcalnota_calificacion->CellAttrs;
            $hrefValue = &$this->AVGcalnota_calificacion->HrefValue;
            $linkAttrs = &$this->AVGcalnota_calificacion->LinkAttrs;
            $this->cellRendered($this->AVGcalnota_calificacion, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->AVGcalnota_calificacion->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpromedioxasignatura_rptsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpromedioxasignatura_rptsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
