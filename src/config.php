...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'UsqhYAIj1qUlpn4T', // Random key for encryption
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\ieproes\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\ieproes\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-f73a7286-9f13-4725-9f3c-54e276c53e3b", // Export folder
